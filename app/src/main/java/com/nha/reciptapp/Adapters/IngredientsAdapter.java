...
import com.nha.reciptapp.Models.ExtendedIngredient;
...
public class   IngredientsAdapter extends RecyclerView.Adapter<IngredientsViewHolder>{
    ...
    public void onBindViewHolder(@NonNull IngredientsViewHolder holder, int position) {
        ...
        Picasso.get().load("https://spoonacular.com/cdn/ingrediets_100x100/"+list.get(position).image).into(holder.imageView_ingredients);
